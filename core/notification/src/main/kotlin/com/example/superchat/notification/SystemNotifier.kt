package com.example.superchat.notification
...
import com.example.superchat.core.notification.R
import dagger.hilt.android.qualifiers.ApplicationContext
import javax.inject.Inject
import javax.inject.Singleton

private const val MAX_NUM_NOTIFICATIONS = 5
private const val TARGET_ACTIVITY_NAME = "com.example.superchat.MainActivity"
...
internal class SystemTrayNotifier @Inject constructor(
    ...
    override fun postNotifications(
        ...
        val notifications = truncatedNewsResources.map { resource ->
            createNotification {
                setSmallIcon(R.drawable.core_notifications_ic_nia_notification).setContentTitle(
                        resource
